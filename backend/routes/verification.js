...
module.exports = function (app) {
    app.get('/send', (req,res) => {
        ...
        host=req.get('host');
        link="http://"+req.get('host')+"/verify?UserType="+UserType+"&id="+code;
        mailOptions={
        to : email,
    ...
    app.get('/verify',function(req,res){
        ...
        if(db_connection.query(profileSearch(req.query.UserType,req.query.id)))
        {
        db_connection.query(updateKey(req.query.UserType,'state', 1, 'code', req.query.id)); //update status
        db_connection.query(updateKey(req.query.UserType,'code', 'Not Assigned', 'code', req.query.id)); //remove code
