  ...
  return (
    <>
      ...
      <div className="student-heading">
        ...
        <img
          src={userProfile[1][0].profile_image === null ? defaultImage(studentName) : userProfile[1][0].profile_image}
          alt={"S"}
        />
        <div className="right">
          {/* Student Name */}
          ...
          <div className="flex-box">
            ...
            {cookie.Type_User === "employer" ? <Button onClick={() => setHirePopup(true)}>Hire</Button> : null}
            <HirePopup show={hirePopup} onHide={() => setHirePopup(false)} setHirePopup={setHirePopup} />
      ...
      <div className="student-qualities">
        ...
        <li>
          {String(userProfile[1].length === 0 ? "No Qualtites" : userProfile[1][0].strengths_qualities)
            .split(",")
            .map((quality) => (
              <ul>{quality}</ul>
            ))}
              ...
              : userProfile[5].map((data) => (
                  <div className="student-experience flex-box">
                    ...
                    <div className="right">
                      ...
                      <p>
                        {converter(data.date_start)} - {converter(data.date_end)}
                      </p>
                      <li>
                        <ul style={{ backgroundColor: "#EFE271" }}>{data.arr_work_done_keywords}</ul>
                      </li>
                    </div>
                  </div>
                ))}
