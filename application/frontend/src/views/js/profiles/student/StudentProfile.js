    ...
    return (
      <>
        ...
        <p style={{ textAlign: "center" }}>
          Let's begin by filling some basic profile information in order for
                    ...
                    <div className='right'>
                      ...
                      <li>
                        {String(project.arr_tools_used)
                          .split(",")
                          .map((tool) => (
                            <ul style={{ backgroundColor: "#66D3D9" }}>
                              {tool}
                            </ul>
                          ))}
                      </li>
                ...
                : userProfile[5].map((experience) => (
                    <div className='student-experience flex-box'>
                      ...
                      <div className='right'>
                        ...
                        <p>
                          {converter(experience.date_start)} -{" "}
                          {converter(experience.date_end)}
                        </p>
                        {/* Keywords */}
                        <li>
